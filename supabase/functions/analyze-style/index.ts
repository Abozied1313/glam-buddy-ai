...
[المخرجات المطلوبة - JSON فقط:]
{
  ...
  "image_generation_prompt": "English-only image edit instruction that lists the exact visible outfit pieces, colors, layering order, and accessories. It must match توصيات_الملابس_والأطقم exactly and must not request changes to face, expression, hair, pose, lighting, background, or camera angle."
}`;
